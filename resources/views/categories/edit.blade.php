    ...
    <section class="content">
        <div class="box box-default color-palette-box">
            <div class="box-header with-border">
                <div class="box-title">
                    <a href="{{ route('categories.index') }}"><span class="btn btn-success">Back</span></a>
                </div>
            </div>
            <div class="box-body">
                <!--------------------------
                ...
                <div class="row">
                    ...
                    <div class="col-md-8">
                        ...
                        <form action="{{ route('categories.update',$category->id) }}" method="post">
                            ...
                            <div class="form-group row">
                                <label for="inputEmail3" class="col-sm-3 col-form-label">Category Add By User</label>
                                <div class="col-sm-9">
                                    <input type="text" value="{{ $category->user->name }}" class="form-control"
                                           readonly="">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="inputEmail3" class="col-sm-3 col-form-label">Category Add On</label>
                                <div class="col-sm-9">
                                    <input type="text" value="{{ $category->created_at }}" class="form-control"
                                           readonly="">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="inputEmail3" class="col-sm-3 col-form-label">Category Update On</label>
                                <div class="col-sm-9">
                                    <input type="text" value="{{ $category->updated_at }}" class="form-control"
                                           name="category_update" readonly="">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="inputEmail3" class="col-sm-3 col-form-label">Category Status</label>
                                <div class="col-sm-9">
